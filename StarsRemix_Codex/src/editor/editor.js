        ...
        <section class="workspace">
          ...
          <aside class="tool-panel">
            <section class="completion-section">
              <div class="section-heading"><p class="step">When ready</p><button class="text-button" id="clear-paint" ${autoGeneratedCount ? "" : "disabled"} title="Remove automatically added houses">Clear paint</button></div>
